...
class Ranking2Protocol:
	...
	def __init__(self):
		self.request_decodes = {
			...
			self.METHOD_GET_ESTIMATE_MY_SCORE_RANK: self.request_decode_get_estimate_my_score_rank,
		}
		self.response_decodes = {
			...
			self.METHOD_GET_ESTIMATE_MY_SCORE_RANK: self.response_decode_get_estimate_my_score_rank,
		}
	...
	@staticmethod
	def request_decode_get_estimate_my_score_rank(input):
		result = {}
		
		result["input"] = input.extract(Ranking2EstimateMyScoreRankInput)
		
		return result
	
	@staticmethod
	def response_decode_get_estimate_my_score_rank(input):
		result = {}

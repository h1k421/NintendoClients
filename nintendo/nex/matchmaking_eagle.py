...
class MatchmakeRefereeProtocol:
	...
	def __init__(self):
		self.request_decodes = {
			...
			self.METHOD_END_ROUND_WITH_PARTIAL_REPORT: self.request_decode_end_round_with_partial_report,
			...
			self.METHOD_GET_EVENT_POINT: self.request_decode_get_event_point,
			self.METHOD_RESET_EVENT_POINT: self.request_decode_reset_event_point,
		}
		self.response_decodes = {
			...
			self.METHOD_END_ROUND_WITH_PARTIAL_REPORT: self.response_decode_end_round_with_partial_report,
			...
			self.METHOD_GET_EVENT_POINT: self.response_decode_get_event_point,
			self.METHOD_RESET_EVENT_POINT: self.response_decode_reset_event_point,
		}
	...
	@staticmethod
	def request_decode_end_round_with_partial_report(input):
		result = {}
	...
	@staticmethod
	def response_decode_end_round_with_partial_report(input):
		result = {}
